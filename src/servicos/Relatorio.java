...
public class Relatorio {
    ...
    public static void gerarResumoFinanceiro(ArrayList<Consulta> consultas, int totalConsultas,
                                             ArrayList<Pagamento> pagamentos, int totalPagamentos,
                                             ArrayList<Double> multas, int totalMultas) {
        int realizadas = 0;
        int canceladas = 0;
